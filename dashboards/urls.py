...
urlpatterns = [ 
   ...
   path('/views_admin_panel_db_operations/manage_reports/generate_weekly_absent_report/<str:start_date>/<str:end_date>/<str:red_zone>', generate_weekly_absent_report, name='generate_weekly_absent_report'),   
